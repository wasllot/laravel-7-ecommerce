									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat">Categiría :<a href="<?php echo e(route('product-cat',$product_detail->cat_info['slug'])); ?>"><?php echo e($product_detail->cat_info['title']); ?></a></p>
...
unset($__errorArgs, $__bag); ?>
																...
																<p class="text-center p-5">
																	Necesitas <a href="<?php echo e(route('login.form')); ?>" style="color:rgb(54, 54, 204)">Ingresar</a> O <a style="color:blue" href="<?php echo e(route('register.form')); ?>">Registrarse</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Basado en <?php echo e($product_detail->getReview->count()); ?> Commentarios</span>
																	</div>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="<?php echo e(route('product-detail',$data->slug)); ?>">
                                            ...
                                            <span class="price-dec"><?php echo e($data->discount); ?> % de descuento</span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\websites\laravel\Advance-Ecommerce-in-laravel-7\resources\views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>