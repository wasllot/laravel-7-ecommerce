            ...
            <div class="row"> 
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2>Registro</h2>
                        <p>Regístrate para ingresar de forma más rápida</p>
                        <!-- Form -->
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        <button class="btn" type="submit">Registero</button>
                                        <a href="<?php echo e(route('login.form')); ?>" class="btn">Ingresar</a>
                                        O
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\websites\laravel\Advance-Ecommerce-in-laravel-7\resources\views/frontend/pages/register.blade.php ENDPATH**/ ?>