				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="call">¿Alguna pregunta? Contáctanos 24/7<span><a href="tel:123456789"><?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($data->phone); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							<h4>Información</h4>
							<ul>
								<li><a href="<?php echo e(route('about-us')); ?>">Acerca</a></li>
								<li><a href="#">Faq</a></li>
								<li><a href="#">Términos y condiciones</a></li>
								<li><a href="<?php echo e(route('contact')); ?>">Contáctanos</a></li>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> <a href="https://github.com/wasllot" target="_blank">Wasllot</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  </script><?php /**PATH C:\Users\User\Desktop\websites\laravel\Advance-Ecommerce-in-laravel-7\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>