			...
			<div class="row">
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							<li><a href="<?php echo e(('home')); ?>">Inicio<i class="ti-arrow-right"></i></a></li>
								...
								<?php else: ?> 
										<tr>
											<td class="text-center">
												No hay carritos disponibles. <a href="<?php echo e(route('product-grids')); ?>" style="color:blue;">Continuar comprando</a>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="<?php echo e(Helper::totalCartPrice()); ?>">Subtotal<span>$<?php echo e(number_format(Helper::totalCartPrice(),2)); ?></span></li>
										...
										?>
										<?php if(session()->has('coupon')): ?>
											<li class="last" id="order_total_price">Pagas<span>$<?php echo e(number_format($total_amount,2)); ?></span></li>
										<?php else: ?>
											<li class="last" id="order_total_price">Pagas<span>$<?php echo e(number_format($total_amount,2)); ?></span></li>
										<?php endif; ?>
									</ul>
									<div class="button5">
										<a href="<?php echo e(route('checkout')); ?>" class="btn">Pagar</a>
										<a href="<?php echo e(route('product-grids')); ?>" class="btn">Continuar comprando</a>
									</div>
								</div>
							</div>
						</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\websites\laravel\Advance-Ecommerce-in-laravel-7\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>